...
case "$VERSION_CODENAME" in
  bookworm)
    test -f $PL_DIR/bindings/bash/powerline.sh || ( pip3 install --user --break-system-packages wheel; pip3 install --user --break-system-packages powerline-status powerline-gitstatus )
    ;;
  *)
