...
if [ "$(uname -m)" = "armv7l" ]; then
  wget -q -nc -O /usr/local/bin/powerline-go https://github.com/justjanne/powerline-go/releases/download/v1.25/powerline-go-linux-arm
elif [ "$(uname -m)" = "aarch64" ]; then
  wget -q -nc -O /usr/local/bin/powerline-go https://github.com/justjanne/powerline-go/releases/download/v1.25/powerline-go-linux-arm64
else
  wget -q -nc -O /usr/local/bin/powerline-go https://github.com/justjanne/powerline-go/releases/download/v1.25/powerline-go-linux-amd64
fi
